...
class HaploProcessorKwargs(ProcessingKwargs, total=False):
...
class HaploProcessor(ProcessorMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if video_processor is None:
            self.video_processor = HaploVideoProcessor()
        else:
    ...
    def __call__(
        ...
        **kwargs: Unpack[HaploProcessorKwargs],
    ) -> BatchFeature:
        output_kwargs = self._merge_kwargs(
            HaploProcessorKwargs,
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        video_processor = HaploVideoProcessor.from_pretrained(
