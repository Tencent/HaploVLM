    ...
    conversation = [
        {
          ...
          'content': [
              {'type': 'text',
               'text': 'Your name is UST developed by Tencent ARC Lab. '
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='UST Test Case')
    parser.add_argument('--model_path', type=str, default="/group/40043/yichengxiao/ust_test",
    ...
    processor = USTProcessor.from_pretrained(args.model_path)
    model = USTForConditionalGeneration.from_pretrained(args.model_path)
