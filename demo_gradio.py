...
from ust import USTProcessor
from ust import USTForConditionalGeneration

# Parse command-line arguments
parser = argparse.ArgumentParser(description='UST Demo')
...
with gr.Blocks(
    ...
    gr.Markdown(
        '# UST: A Single-Transformer Baseline for Multi-Modal Understanding')
